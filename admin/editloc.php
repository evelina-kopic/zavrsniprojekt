    ...
    <section class="">
        ...
        <form method="post">
            <table class="inv">
                <tr>
                <tr>
                    <p style="height:30px;color: #ededed; font-family: 'Quicksand'; margin-top: 10px; font-size: 20px;">ODABERITE NAZIV LOKACIJE KOJA SE BRIŠE:</p>
                </tr>
                <tr>

                    <select name="LOCATION_DEL" required style="margin-right: 10px;">
                        <option> Odaberite Lokacija:</option>
                        <?php
                ...
                <tr>
                    <input type="submit" name='loc_delete' value="OBRIŠI">
                </tr>
                </tr><br>
                <tr>
                    <input type="submit" name='add' value="DODAJ NOVU LOKACIJU">
                </tr>
            </table>
        </form>
        <?php
        ...
        if (isset($_POST['add'])) {
            ...
            <div class="wrapper" style="display: flex; margin-top: 50px;">
                <form method="post" onsubmit="func()" style="margin: 0 auto;">
                    <table>
                        <tr>
                            <td class="tds">ID Lokacije:</td>
                            <td><input type="text" name="LOCID" required></td>
                        </tr>
                        <tr>
                            <td class="tds">NAZIV LOKACIJE:</td>
                            <td><input type="text" name="LOCNAME" required></td>
                        </tr>
                        <tr>
                            <td class="tds">ULICA:</td>
                            <td><input type="text" name="STREET" required></td>
                        </tr>
                        <tr>
                            <td class="tds">GRAD:</td>
                            <td><input type="text" name="CITY" required></td>
                        </tr>
                        <tr>
                            <td class="tds">DRŽAVA:</td>
                            <td><input type="text" name="STATE" required></td>
                        </tr>
                        <tr>
                            <td class="tds">POŠTANSKI BROJ:</td>
