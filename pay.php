...
<head>
    <title>E-Scoot Iznajmljivanje</title>
    <meta charset="utf-8">
...
<body>
    ...
    <section class="">
        ...
        $rs = $conn->query($sel);
        $rs1 = $conn->query($sel);
        $cost = "SELECT * FROM scooter WHERE REGISTRATION_NUMBER = '$_GET[id]'";
        $cs = $conn->query($cost);
        $cpd = $cs->fetch_assoc();
        ...
        <section class="caption">
            <h1 style="text-align: center; font-size:xxx-large;"><span style="font-weight: 100;">Pronađite najbolji </span>Skuter za SEBE!</h1>
        </section>
