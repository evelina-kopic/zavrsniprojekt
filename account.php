	...
	<section class="wrapper" id="contact" style="max-width: 1350px;">
		...
		<div class="wrapper cntform" style="margin-top: 12.5%">
			<div>
				...
				<h1 class="logo" style="color: #ededed; font-size: 40px;"><img id="logoimg" src="/ev/assets/favicon_io/android-chrome-512x512.png" alt="logo" width="37" height="37"> E-Scoot</h1>
				<address>
				Orasje VII. ulica,<br>
			...
			<div class="wrapper">
				<div>
					<form method="post">
						<h1><span style="text-align: center; font-size:xxx-large; color: #49c5b6; filter: drop-shadow(0px 0px 15px #49C5B6);"> Prijava</span></h1>
						<div>
							<input class="txtcenter" type="email" name="EMAIL_ID" placeholder="E-mail" required style="width:300px">
						</div>
						<div>
							<input class="txtcenter" type="password" name="PASSWORD" placeholder="Lozinka" required style="width:300px">
						</div>
						<div>
							<input class="but" type="submit" name="log" value="Prijavi se" style="width: 100px; color: #ededed; background: #49c5b6;">
						</div>
						<p style="margin-top:20px;color: #ededed; font-family: 'Quicksand';">Nemate račun? <a href="signup.php" style="color: #49c5b6; font-weight: bold;">Registrirajte se!</a></p>
					</form>
					...
					?>
						...
						?>
							<div class="flash-message" style="margin: 40px auto; background: red; width: 250px;">
								<?php echo 'Greška pri prijavi. Pokušajte ponovo!'; ?>
							</div>
					<?php
						}
					}
