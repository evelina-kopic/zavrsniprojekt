...
<head>
    <title>E-Scoot | Rentaj Skutere</title>
    <meta charset="utf-8">
    ...
    <section class="listings">
        <div class="wrapper" style="max-width: 1250px;;">
            <ul class="properties_list">
                ...
                $sel = "SELECT * FROM scooter WHERE AVAILABILITY_FLAG = 'Y'";
                $sel1 = "SELECT COST_PER_DAY FROM scooter";
                $rs = $conn->query($sel);
                $rs1 = $conn->query($sel1);
                ...
                ?>
                    ...
                    <li>
                        <a href="book_scooter.php?id=<?php echo $rws['REGISTRATION_NUMBER'] ?>">
                            <img class="thumb carimg" src="scooters/<?php echo $rws['image']; ?>" width="450" height="225">
                        </a>
