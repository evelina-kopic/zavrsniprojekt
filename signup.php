...
<head>
    <title>E-Scoot | Registracija</title>
    <meta charset="utf-8">
                    ...
                    <form method="post" style="margin: 0 auto;">
                        <table>
                            ...
                            <tr>
                                ...
                                <<td><input type="password" name="CPASSWORD" required autocomplete="new-password"></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="text-align:center">
                                    <input class="but" type="submit" name="save" value="POTVRDI"
                    ...
                    if (isset($_POST['save'])) {
                        ...
                        if ($pwd != $cpwd) {
                            ...
                            <div class="flash-message" style="margin: 40px auto; background: red; width: 250px;">
                                <?php
                                echo "Lozinke se ne podudaraju, pokušatje ponovo!";
                                exit();
                                ?>
                            </div>
                            <?php
                        ...
                        try {
                            ...
                            ?>
                            <div class="flash-message" style="margin: 40px auto; background: red; width: 250px;">
                                <?php echo 'Registracija nije uspjela. ID e-pošte ili broj vozacke dozvole već postoji. Pokušajte ponovno'; ?>
                            </div>
                            <?php
                            exit();
                        ...
                        if ($ress == TRUE) { ?>
                            <div class="flash-message" style="margin: 40px auto; width: 250px;">
                                <?php echo 'Uspješna prijava';
                                // header('location: account.php');
                                ?>
                            </div>
                            <div class="flash-message" style="margin: 5px auto; width: 250px;">
                                <a href="account.php">NASTAVI NA PRIJAVU</a>
                            </div>
                            <?php
                        } else {
                            ?>
                            <div class="flash-message" style="margin: 40px auto; background: red; width: 250px;">
                                <?php echo 'Registracija nije uspjela. Pokušajte ponovno'; ?>
                            </div>
                            <?php
                        }
                    }
